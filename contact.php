...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="./index"><img src="img/logo.png" alt="The Beauty salon, home salon in Ranchi, salon at home"></a>
        </div>
        <div class="humberger__menu__cart">
            ...
            <div class="header__cart__price">item: <i class="fa fa-inr"></i><span>00</span></div>
        </div>
        ...
        <div class="humberger__menu__contact">
            <ul>
                ...
                <li>Free one beauty services on booking of <i class="fa fa-inr"> 999/-</i> or above</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index"><img src="img/logo.png" alt="The Beauty Salon, salon at home in Ranchi"></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            <a class="text-dark" href="./index">Home</a><i class="fa fa-long-arrow-right"></i>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Address</h4>
                        <p>Harmu Road, Ranchi (Jharkhand)</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Email</h4>
                        <p>thebeautyparlour@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="map">
        ...
        <div class="map-inside">
            ...
            <div class="inside-widget">
                <h4>Ranchi</h4>
                <ul>
                    <li>Phone: +91-6203511518</li>
                    <li>Add: Harmu Road, Ranchi</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index"><img src="img/logo.png" alt="The Beauty Salon logo image"></a>
                        </div>
                        <ul>
                            <li>Address: Harmu Road, Ranchi.</li>
                            <li>Phone: +91-6203511518</li>
                            <li>Email: thebeautyparlour@gmail.com</li>
                        </ul>
                    </div>
                </div>
